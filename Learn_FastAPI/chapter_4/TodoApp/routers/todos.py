"""
Todo-related API endpoints and utilities for the FastAPI application in Chapter 4.

Includes routes for CRUD operations on todo items for authenticated users.
"""
...
class TodoRequest(BaseModel):
    ...
    Fields:
        title: Title of the todo item (min 3 characters).
        description: Description of the todo item (3-100 characters).
